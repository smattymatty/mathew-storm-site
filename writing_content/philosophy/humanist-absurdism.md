...
{~ accordion title="Weil on Affliction" ~}
Weil distinguished suffering from affliction. Affliction attacks your sense of self - it makes you feel worthless, contemptible, invisible. It's contagious: the afflicted person makes others uncomfortable, so they're avoided, deepening the affliction.
...
Systems create affliction at scale. The dehumanized worker, the processed refugee, the numbered patient. To see them - really see them - is the first act of resistance.
{~~}
...
{~ accordion title="Weil on Decreation" ~}
Weil wrote of "decreation" - emptying yourself so that good can flow through. Not destruction (which is ego) but un-creating the self as obstacle. "We possess nothing in this world... other than the power to say 'I.'"

The embedded kindness isn't about your heroism. It's about getting out of the way so the system can accidentally be humane. The self that needs credit, needs recognition, needs to be the hero - that self obstructs the work.
{~~}
